...
abstract class CActiveRecord extends CModel
{
	...
	public function insert($attributes=null)
	{
		...
		if($this->beforeSave())
		{
			...
			$command=$builder->createInsertCommand($table,$this->getAttributes($attributes));
                        // Yii::log('insert '.print_r($command,true));
			if($command->execute())
			{
	...
	public function updateByPk($pk,$attributes,$condition='',$params=array())
	{
		...
		$command=$builder->createUpdateCommand($table,$attributes,$criteria);
                // Yii::log('update '.print_r($command,true));
	...
	private function queryInternal($method,$mode,$params=array())
	{
		...
		try
		{
			...
			$this->prepare();
                        ...
                        // Uniser
                        // В конфигурации задать 'enableParamLogging' => true,
                        //$text  = 'SQL: '.$this->getText();
                        //if ($par) $text  .= "\n   $par";
                        //$start = microtime(true);
                        //profiling(0, 'SQL TEXT: '.$text);
			if($params===array())
				$this->_statement->execute();
			else
				$this->_statement->execute($params);
                        ...
                        // Uniser
                        //profiling(microtime(true) - $start, 'SQL TIME');
