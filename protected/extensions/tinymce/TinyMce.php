...
class TinyMce extends CInputWidget
{
    ...
    private static $defaultSettings = array(
        ...
        'plugins' =>"advlist,autolink,lists,link,image,charmap,print,preview,hr,anchor,pagebreak,searchreplace,visualblocks,visualchars,code,insertdatetime,media,nonbreaking,table,contextmenu,directionality,paste,emoticons,textcolor,spellchecker,save",
        'spellchecker_language' => 'ru',
        'spellchecker_rpc_url' => "http://speller.yandex.net/services/tinyspell",
        
        'toolbar' =>"undo,redo,|,styleselect,fontselect,fontsizeselect,|,bold,italic,|,alignleft,aligncenter,alignright,alignjustify,|,bullist,numlist,outdent,indent,|,forecolor,backcolor,emoticons,|,blockquote,removeformat,charmap,|,link,unlink,imageprint,image,media,|,visualchars,nonbreaking,pagebreak,ltr,rtl,|,spellchecker,preview,code",
        // Theme options
    ...
    {
        $dir = dirname(__FILE__) . '/vendors/tinymce/jscripts/tinymce';
    ...
    private function registerScripts($id)
    {
        ...
        if ($this->compressorRoute === false) {
            ...
            $cs->registerScriptFile($this->assetsDir . '/langs/' . $this->settings['language'] . '.js');
        } else {
