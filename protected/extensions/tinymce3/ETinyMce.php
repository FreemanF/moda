...
class ETinyMce extends CInputWidget
{
   ...
   *
   ...
   $options['extended_valid_elements'] = "iframe[src|title|width|height|frameborder|allowfullscreen],article[class|style|id|data],h3[align<center?justify?left?right|class|dir<ltr?rtl|id|lang|onclick|ondblclick|onkeydown|onkeypress|onkeyup|onmousedown|onmousemove|onmouseout|onmouseover|onmouseup|style|title|data-number],span[align<center?justify?left?right|class|dir<ltr?rtl|id|lang|onclick|ondblclick|onkeydown|onkeypress|onkeyup|onmousedown|onmousemove|onmouseout|onmouseover|onmouseup|style|title|data-label]";
      $options['spellchecker_languages'] = '+Russian=ru,Ukrainian=uk,English=en';
      $options['spellchecker_rpc_url'] = 'http://speller.yandex.net/services/tinyspell';
   ...
   protected function makeCompressor()
   {
	...
	protected function makeOptions($url='')
	{
      ...
      if ($this->fileManager !== false) {
         ...
         $fm->init();
         $options['file_browser_callback'] = $fm->getFileBrowserCallback();
     }
	...
	public function init()
	{
      ...
      Yii::app()->getAssetManager()->newDirMode = 0755;
      Yii::app()->getAssetManager()->newFileMode = 0644;
      $assets = Yii::app()->getAssetManager()->publish($baseDir.DIRECTORY_SEPARATOR.'assets');
      Yii::app()->getAssetManager()->newDirMode = 0777;
      Yii::app()->getAssetManager()->newFileMode = 0666;
