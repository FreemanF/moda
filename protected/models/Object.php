...
Object::idUsers        =>array(  25, 'users'       , 'us' , 0, 0, 0, 5, 0, 0, 0, 0, 0,  80, 0,  0, 'phonebook'  , 'Пользователи сайта'          , 'users'        , 'пользователя'          , 'Пользователи сайта'          , 'Пользователи сайта'      ),
...
Object::idBrand      =>array( 36, 'client'   ,   'cl', 1, 0, 0, 3, 0, 0, 0, 0, 0,  55, 0,  3, 'images'     , 'Бренд'          		  , 'client' 	  , 'бренда'          		, 'Бренды'          	  , 'Бренды'      		),
Object::idProduct     =>array( 29, 'product'  ,  'pd', 1, 0, 0, 3, 0, 0, 0, 0, 0,  55, 0,  3, 'images'     , 'Продукция'             , 'product' 	  , 'продукта'          	, 'Товары'          	  , 'Товары'      ),
Object::idSize      =>array(  59, 'size'       , 'sz' , 0, 0, 0, 3, 0, 0, 0, 0, 0,  74, 0,  0, 'settings4'  , 'Размер'               , 'size'        , 'размера'               , 'Размеры'               , 'Размеры'           ),
//Object::idNews      =>array(  1, 'news'       , 'n' , 0, 0, 0, 3, 0, 0, 0, 0, 0,  70, 0,  2, 'news'       , 'Новость'               , 'news'        , 'новости'               , 'Новости'               , 'Новости'           ),
Object::idArticle    =>array(  52, 'article'   , 'ar' , 0, 0, 0, 3, 0, 0, 0, 0, 0,  71, 0,  2, 'news'   , 'Статья'               , 'article'    , 'статьи'               , 'Статьи'               , 'Статьи'           ),
...
Object::idContacts  =>array( 18, 'contacts'     , 'cn' , 0, 0, 0, 3, 0, 0, 0, 0, 0,  90, 0,  2, 'news'       , 'Конт. сообщения'               , 'contacts'        , 'Конт. сообщения'      , 'Конт. сообщения'   , 'Конт. сообщения'          ),
Object::idCity       =>array( 92, 'city'        , 'ct' , 0, 0, 0, 3, 0, 0, 0, 0, 0,  20, 0,  2, 'city'       , 'Город'               , 'city'        , 'города'               , 'Города'                 , 'Города'          ),
Object::idDialogs  =>array( 30, 'dialogs'       , 'dl' , 0, 0, 0, 0, 0, 0, 0, 0, 0, 40, 0,  7, 'dialogs'     , 'Диалоги'             , 'dialogs'     , 'диалоги'               , 'Диалоги'               , 'Диалоги'          ),
Object::idMessages  =>array( 31, 'messages'     , 'ms' , 0, 0, 0, 0, 0, 0, 0, 0, 0, 40, 0,  8, 'messages'    , 'Сообщения'           , 'messages'    , 'сообщения'              , 'Сообщения'            , 'Сообщения'        ),
Object::idReplyes  =>array( 32, 'replyes'       , 'rp' , 0, 0, 0, 0, 0, 0, 0, 0, 0, 40, 0,  9, 'replyes'     , 'Ответы'              , 'replyes'     , 'ответы'                 , 'Ответы'               , 'Ответы'           ),
Object::idAttachment  =>array( 35, 'attachment'       , 'at' , 0, 0, 0, 0, 0, 0, 0, 0, 0, 40, 0,  9, 'attachment'     , 'Вложения'              , 'attachment'     , 'Вложения'                 , 'Вложения'               , 'Вложения'           ),
