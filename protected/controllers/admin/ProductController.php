...
class ProductController extends CRUDController
{
    ...
    protected function beforeValidation() {
        if(!$this->model->pd_sef)
            $this->model->pd_sef = TranslitFilter::translitUrl($this->model->pd_name);
    }
    
    public function getIndexColumns3() {
        // 0 - id
        // 1 - name
        // 2 - dt_start
        // 3 - Buttons
        ...
        $this->insertColumn($columns, 2, array(
           ...
           'filter' => CHtml::dropDownList('Product[pd_category]',$this->model->pd_category,
                Category::getList(Object::idProduct),
                array(
