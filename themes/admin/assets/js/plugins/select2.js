...
(function ($, undefined) {
                ...
                opts.query = this.bind(function (query) {
                    ...
                    process=function(element, collection) {
                        ...
                        if (element.is("option")) {
                            ...
                            // Xa-Xa-Xa if (group.children.length>0) {
                                collection.push(group);
                            //}
                        }
                    };
    ...
    $.fn.select2.defaults = {
        ...
        formatNoMatches: function () { return "Не найдено соответствий"; },
        formatInputTooShort: function (input, min) { var n = min - input.length; return "Пожалуйста введите " + n + " либо больше символов"; },
