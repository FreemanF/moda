...
<div class="b-section">
        <div class="b-section__container">
            <div class="b-main b-main_state_inverse">
                <div class="b-block">
                    <h1 class="b-title">Запросы на отзыв</h1>
                </div>
                <div class="b-tabs">
    ...
    <div class="b-main__content">
        <div class="b-main__inner">
            <div class="b-main__block js-review-requests">Запросов нет</div>
        </div>
    </div>
...
<script defer src="<?php echo $this->themeCss; ?>assets/build/global.js"></script>
    ...
    <script defer src="<?php echo $this->themeCss; ?>assets/build/reviews.js"></script>
