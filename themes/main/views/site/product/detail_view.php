...
<meta itemprop="url" content="<?php echo Yii::app()->createAbsoluteUrl(Yii::app()->request->url); ?>" />
...
<div class="b-product__params b-product-params b-product-params_theme_white b-product-params_col_2">
    ...
    <div class="b-product-properties">
        ...
        <div class="b-product-properties__row">
            ...
            if (!Yii::app()->user->isGuest){
                ...
                $criteria->condition = 'dl_user='.Yii::app()->user->id.' OR dl_to='.Yii::app()->user->id;
                $criteria->addCondition('dl_product='.$this->model->pdid);
                $dlg = Dialogs::model()->find($criteria);
            //    if (!$dlg){
    ...
    <h3 class="b-product-message__title">
        Задать вопрос продавцу
            ...
            if (!Yii::app()->user->isGuest){
                if (!$dlg){
                    echo'<div class="b-product-message__image-wrapper">
...
//            $criteria->addCondition('dl_product='.$this->model->pdid);
//            $dlg = Dialogs::model()->find($criteria);
//            echo print_r($dlg,true);
//            Yii::app()->end();
            if ($dlg){
                echo "<a class='b-button b-product-message__button-long' href='".Yii::app ()->createAbsoluteUrl ('msg/'.$dlg->dlid)."'>Перейти к диалогу</a>";
            } else {
    ...
    <meta itemprop="availability" itemtype="http://schema.org/ItemAvailability" content="http://schema.org/InStock"/>
        ...
        <div class="b-desktop-only">
            <div class="b-product__button_container">
                <a href="<?php echo Yii::app ()->createAbsoluteUrl ('users/register'); ?>" class="b-button b-button_fs_18 b-button_lh_24 b-button_bg_red b-product__button">Хочу!</a>
            </div>

            <div class="b-product__button_container">
                <a href="<?php echo Yii::app ()->createAbsoluteUrl ('users/register'); ?>" class="b-button-bordered b-button-bordered_lh_24 b-button-bordered_theme_gray b-button-bordered_theme_transparent b-product__button b-product__button-follow">
...
-->
    ...
    <div class="b-product b-sticky-bar">
        ...
        <a href="<?php echo Yii::app ()->createAbsoluteUrl ('users/register'); ?>" class="b-sticky-bar__button b-sticky-bar__button_type_follow">
            <svg class="b-sticky-bar__button_type_follow-icon">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="//sprites/defs/svg/sprite.defs.svg#static--svg--heart"></use>
            </svg> В избранное
        </a>
    </div><div class="b-sticky-bar__button-container">
        <a href="<?php echo Yii::app ()->createAbsoluteUrl ('users/register'); ?>" class="b-sticky-bar__button b-sticky-bar__button_type_want_it">Хочу!</a>
    </div>
        </div>
