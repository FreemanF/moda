        ...
        <div class="b-section__container b-add-product js-add-product">
                ...
                <div class="b-form-row">
					...
					<div class="b-image-upload">
						...
						<li class="b-image-upload__item">
							<div class="b-image-upload___item-inner">
								...
								<div class="b-image-upload__image-container">
                                                                <img id="b-image-upload__image2" class="b-image-upload__image" src="<?php if ($this->model->media2) { echo $this->model->media2->getMediaUrl('original'); } ?>" alt="your image" style="height:100%;display: block;">
								</div>
						...
						<div class="b-image-upload__image-container">
						<img id="b-image-upload__image1" class="b-image-upload__image" src="<?php if ($this->model->media) { echo $this->model->media->getMediaUrl('original'); } ?>" alt="your image" style="height:100%;display: block;">
						</div>
						...
						<input id="upload-img1" class="b-image-upload__upload-input" name="upload-img1" accept="image/*" title="Кликните для выбора фото" multiple="" type="file">
							...
							<div class="b-imgage-main b-green">
                                                            <input id='image-main' name="image-main" type="hidden" value="1" style="display:none;">
                                                            <p class='img-main2' style="cursor: pointer;">Сделать главным</p>
                                                        </div>
						</li>
						<li class="b-image-upload__item">
						<div class="b-image-upload___item-inner">
						...
						<div class="b-image-upload__image-container">
						<img id="b-image-upload__image3"  class="b-image-upload__image3" src="<?php if ($this->model->media3) { echo $this->model->media3->getMediaUrl('original'); } ?>" alt="" style="height:100%;display: block;">
						</div>
						<input class="style-input-js" name="cover-style" value="" type="hidden">
						...
						<div class="b-imgage-main b-green"><input name="image-main" type="checkbox" style="display:none;"><p class='img-main3' style="cursor: pointer;">Сделать главным</p></div>
						</li>
						</ul>
					<style>
						...
						transform: translateY(-50%);
                                        ...
                                        $( document ).ready(function() {
                                            $("p.img-main1").click(function () {
                                                ...
                                                $(this).val("Главное");
                                                $("p.img-main2").val("Сделать главным");
                                                $("p.img-main3").val("Сделать главным");
                                           ...
                                           $("p.img-main2").click(function () {
                                               ...
                                               $(this).parent("div.b-imgage-main").removeClass("b-green");
                                               $(this).val("Главное");
                                               $("p.img-main1").val("Сделать главным");
                                               $("p.img-main3").val("Сделать главным");
                                           ...
                                           $("p.img-main3").click(function () {
                                            ...
                                            var main_img = <?php echo $this->model->pd_main_media; ?>;
                                            if (main_img == 1)
                                            {
                                                $("p.img-main1").trigger("click");
                                            }
                                            if (main_img == 2)
                                            {
                                                $("p.img-main2").trigger("click");
                                            }
                                            if (main_img == 3)
                                            {
                                                $("p.img-main3").trigger("click");
                                            }
                        ...
                        <li class="b-describe__item">
                            <label class="b-describe__label" for="product-condition">Состояние *</label>
                                <select style="width:100%;" name="Product[state]" id="Product_state">
                                    <option <?php if($this->model->pd_state == 0) { echo 'selected';} ?> value="0">Новое</option>
                                    <option <?php if($this->model->pd_state == 0) { echo 'selected';} ?> value="1">Идеальное</option>
                                    <option <?php if($this->model->pd_state == 0) { echo 'selected';} ?> value="2">Хорошее</option>
                                </select>
                        </li>
                        <li class="b-describe__item">
...
<!--                            <textarea placeholder="Например: Отправлю вещь только после оплаты половины на карточку" name="delivery" id="product-pay" class="b-form-textarea b-describe__form_item">предоплата на карту, отправка в течении суток</textarea>-->
                ...
                <div class="b-form-row">
                    ...
                    foreach ($cs as $cs => $val){
                        if ($l_count == $this->model->pd_color)
                        {
                            $active = 'c'.$l_count;
                        } else {
                            $active = '';
                         ...
                         //echo $val['cp_name']."<br/>";
                         //echo $val['cp_rgb']."<br/>";
                         echo '<li id="'.$l_count.'" class="b-choose-color__item '.$active.'">
                ...
                <div class="b-form-row">
                    ...
                    <div class="b-section"></div>
                    <div class="b-info-columns" style="width:50%;">
                        ...
                        <label for="gift" class="b-info-columns__item" style="display:none;">
...
<script defer src="<?php echo $this->themeCss; ?>assets/build/new_listing.js2"></script>
