...
-->
								<h4 class="b-info-slider__title">КАК СДЕЛАТЬ ПРИВЛЕКАТЕЛЬНОЕ ФОТО:</h4>
                                                                <div style="background-color:rgba(206, 206, 206, 0.36); text-align: justify;font-size: 17px;font-weight: 400;color: #000;padding: 5px;">
Фото на модели или манекене всегда выглядит лучше, чем на кровати или вешалке.<br/>
На главном фото вещь должна быть показана в полный рост.
Выглаженная и чистая одежда найдет своего нового хозяина быстрее.<br/>
Одежда и фон не должны быть одно цвета. Используйте нейтральный фон.<br/>
Делайте фото при натуральном освещении. Солнечный свет лучше любых ламп.
Чтобы избежать размытого фото мелких деталей, используйте режим макросъемки.<br/>
Не обрабатывайте фото в графических редакторах.
Делайте фото сами, не используйте фото из сети
Если Вы делаете фото в зеркале, выключите вспышку и протрите зеркало.</div>
					<!--		
                                        </div>
						</div>
						</div>
					...
					<div class="b-image-upload">
						...
						Загрузите пожалуйста, как минимум одно основное фото Вашей вещи.
						...
						<li class="b-image-upload__item">
							...
							<div class="b-imgage-main"><input name="image-main" value="0" type="checkbox" style="display:none;"><p class='img-main1' style="cursor: pointer;">Главное</p></div>
						</li>
						...
						<input id="upload-img1" class="b-image-upload__upload-input" name="upload-img1" accept="image/*" title="Кликните для выбора фото" multiple="" type="file">
							...
							<div class="b-imgage-main b-green">
                                                            <input id='image-main' name="image-main" type="hidden" style="display:none;"><p class='img-main2' style="cursor: pointer;">Сделать главным</p>
                                                        </div>
						</li>
						<li class="b-image-upload__item">
						<div class="b-image-upload___item-inner">
                ...
                <div class="b-form-row">
                    ...
                    <ul class="b-describe">
                        ...
                        <input type="text" class="b-form-input b-describe__input b-describe__form_item" id="product-name" placeholder="Введите название Вашего товара" autocomplete="off" maxlength="254" value="" name="title">
                        </li>
...
<select style="width:100%;" value="" name="Product[state]" id="Product_state">
...
<option value="2">Хорошее</option>
		...
		echo CHtml::dropDownList('brand','',$a,array('class'=>'form-control'));
                ?>
                        ...
                        <li class="b-describe__item b-describe__item_span_2">
                            <label for="product-description" class="b-describe__label">Описание*</label>
                            <textarea class="b-form-textarea b-describe__form_item" id="product-description" name="description" placeholder="Например: в этом платье, Вы будете королевой" maxlength="4096" required="required"></textarea>
                        </li>
                        <li class="b-describe__item">
                            <label for="product-consist" class="b-describe__label">Состав</label>
                            <textarea class="b-form-textarea b-describe__form_item" id="product-consist" name="composition" placeholder="Например: 50% лен,50% котон" maxlength="250"></textarea>
                        </li>
                        <li class="b-describe__item">
                            <label for="product-pay" class="b-describe__label">Оплата и доставка</label>
                            <textarea class="b-form-textarea b-describe__form_item" id="product-pay" name="delivery" placeholder="Например: Отправлю вещь только после оплаты половины на карточку"></textarea>
                        </li>
                    </ul>
                </div>
                                <div class="b-form-row">
                                    <h3 class="b-title_type_thin b-add-product__title" style="margin: 0;">Выберите ближайший город</h3>
                                    <?php
        $cityes = City::model()->findAll();
        
        
        $a= CHtml::listData($cityes,'ctid','ct_name');
	echo CHtml::dropDownList('city','',$a,array('class'=>'selectpicker',
                ...
                <div class="b-form-row">
                    <h2 class="b-title_type_thin b-add-product__title" style="margin: 0;">Выберите категорию      <span class="glyphicon glyphicon-hand-down"></span></h2>
	...
	echo CHtml::dropDownList('first_cat','',$a,array('class'=>'selectpicker',
...
jQuery.ajax({'type':'post','url':'\x2Fsite\x2Fsize','data':{'cid':$('#first_cat').val()},'cache':false,'success':function(html){jQuery('#size_list').html(html)}});
        }",   
                       // 'dataType' => 'JSON',  
                    )
                    ));
...
<?php
    echo CHtml::dropDownList('second_cat','', array(),array(
        ...
        'style'=>'margin-top:20px; width:49%; font-size:1.3em;'
        ));
?>
...
<!--                    
                    ...
                    <div class="b-choose-size">
                        <div id="size_list" class="b-choose-size__list">
                            <?php
//                            if (isset($_POST['cid']))
//                            {
//                                echo print_r($_POST, true);
//                                $this->renderPartial('_size');
//                            }
                            ?>
<script>
//jQuery('body').on('change','#second_cat',function(){jQuery.ajax({'type':'post','url':'\x2Fsite\x2Fsize','data':{'cid':$('#first_cat').val()},'cache':false,'success':function(html){jQuery("#size_list").html(html)}});return false;});
</script>
<!--
                ...
                <div class="b-form-row">
                    ...
                    foreach ($cs as $cs => $val){
                         ...
                         echo '<li id="'.$l_count.'" class="b-choose-color__item">
                                <input type="checkbox" class="b-hidden" value="on">
                                <span class="b-choose-color__color" style="border: 2px solid'.$val['cp_rgb'].';background-color:'.$val['cp_rgb'].';';
                        if ($val['cpid'] == 16)
                        {
                            echo 'background:'.$val['cp_rgb'].';';
                        }
                        echo '">&nbsp;</span>
                    ...
                    <div class="b-info-columns salex">
                        <label class="b-info-columns__item" for="price" style="width:50%;display: inline-table;">
                            ...
                            <span class="b-info-columns__left-part">
                                <input type="text" id="price" value="" class="b-form-input" placeholder="300" autocomplete="off" name="price" style="color:#000;" required="required">
                            </span>
...
<!--                    
                    <input type="checkbox" class="b-form-check-input" id="i-took-pic" name="i-took-pic" rel="iaccept" value="1" title="Я добавила как минимум одно фото вещи, которое сделала сама. Почему это важно?" autofill-prediction="">
                    ...
                    -->
                    <button id="new_form" class="b-button b-add-product__add-button" type="submit">Добавить вещь</button>
                    <div class="b-section"></div>
                </div>
            </form>
        </div>
...
//$.validator.addMethod("iaccept",function(value) {
//    var acc = $('input:hidden[name="i-took-pic"]').is(':checked');
//    if (acc == true)
//        return true;
//    else
//        return false;
//    }, "Подтвердите что Вы сделали хотя бы одно фото сами!");
//    
//    $.validator.classRuleSettings.iaccept = { iaccept: true };
    
$.validator.addMethod("imgFile",function(value) {
      if ( ( $('#b-image-upload__image1').attr('src') !== '#') || ( $('#b-image-upload__image2').attr('src') !== '#') || ( $('#b-image-upload__image3').attr('src') !== '#') )
      {
        return true;
      } else {
          return false;
      }
    }, "Выберите хотябы одно фото вашей вещи!");

    $.validator.classRuleSettings.imgFile = { imgFile: true };
...
//    'ignore': false,
         ...
         'i-took-pic':{
             required: {
                depends: function(element) {
                    return $('input:hidden[name="i-took-pic"]').is(":checked");
                }
             }
         },
        },
    messages:{
         'title': {
             ...
             maxlength: "Максимальное число символов - 254",
         },
         'Product[state]': {
            required: "Пожалуйста, выберите состояние товара",
        },
         'brand': {
         ...
         'description': {
             required: "Это поле обязательно для заполнения",
             minlength: "Описание должно быть минимум 3 символа",
             maxlength: "Максимальное число символов - 254",
         },
        'first_cat':{
             required: "Это поле обязательно для заполнения",
        ...
        'price':{
             required: "Укажите обязательно цену",
         },
        'upload-img2':{
             imgFile: "Выберите хотябы одно фото вашей вещи!",
         },
        'i-took-pic':{
             required: "Подтвердите, что Вы добавили хотя бы одно фото Вашей вещи",
         },
     },
...
//      }
    ...
    //валидация состав
    $('#product-consist').on('input', function() {
	var input=$(this);
	var message=$(this).val();
	console.log(message);
	if(message){input.removeClass("invalid").addClass("valid");}
    ...
    //валидация оплата и доставка
    $('#product-pay').on('input', function() {
	var input=$(this);
	var message=$(this).val();
	console.log(message);
	if(message){input.removeClass("invalid").addClass("valid");}
...
/*
    jQuery("#new_form").on('submit',function(e){
    if ($('#Product_state').length == 0){
        $('#Product_state').removeClass("valid").addClass("invalid");
    } else {
        $('#Product_state').removeClass("invalid").addClass("valid");
    }
    //cat first
    if ($('#first_cat').length == 0){
        $('#first_cat').removeClass("valid").addClass("invalid");
    } else {
        $('#first_cat').removeClass("invalid").addClass("valid");
    }
    //second category
    if ($('#second_cat').length == 0){
        $('#second_cat').removeClass("valid").addClass("invalid");
    } else {
        $('#second_cat').removeClass("invalid").addClass("valid");
    }
    */
    
//    var self = this;
//    e.preventDefault();
//    var err_count = length($('.invalid'));
//    if (err_count > 0){
//        e.preventDefault();
//    } else {
...
label.error {
    color: #ff003f;
    font-size: 14px;
    border: 1px solid rgba(57, 123, 90, 0.58);
