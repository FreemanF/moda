        ...
        <div class="b-auth__wrapper">
            <a href="/">
                <div class="b-auth__logo">
					<img class="b-auth__logo-image" src="<?php echo $this->themeCss; ?>/assets/logo.png">
                </div>
            </a>
            
    <form class="b-auth__form" method="post">
        <h1 class="b-auth__title">Вход</h1>
        <div class="b-auth__form-row">
            <input type="text" class="b-form-input" placeholder="Логин" value="" name="username"/>
            <div class="b-form-error"></div>
        </div>
        <div class="b-auth__form-row">
            <input type="password" class="b-form-input" placeholder="Пароль" value="" name="password" autocomplete="off"/>
            <div class="b-form-error"></div>
            <div class="b-form-error"></div>
        </div>
        ...
        <div class="b-auth__form-row">
            <button class="b-auth__button b-button b-button_fs_18 b-button_fw_normal" type="submit">Войти</button>
        </div>

        <div class="b-auth__form-row">
            <a href="/login/reset-password" class="b-auth__link">Восстановить пароль</a>
        </div>

        <a href="https://fontez.com/page/kak-uznat-svoj-login" class="b-auth__link b-auth__link_type_small">Как узнать свой логин</a>
        <br>
        <a href="https://fontez.com/page/vhod-po-loginu-i-parolyu" class="b-auth__link b-auth__link_type_small">У меня нет пароля</a>
    </form>
