...
<li class="b-catalog__item" id="b-catalog__item-5495211">
            <a class="b-catalog__link js-ga-onclick " href="/product/<?php echo $data->pd_sef; ?>" data-event-action="Open from TOP category" data-event-category="Open" data-event-label="3" data-id="<?php echo $data->pdid; ?>" title="<?php echo $data->pd_name; ?>">
			...
			<img class="b-catalog__img js-lazy-img" src="<?php echo $image; ?>" style="min-height:325px;" />
        <noscript>
        ...
        <span class="b-catalog__info b-catalog__info_promoted">
            <span class="b-catalog__name"><?php echo $data->brand->cl_name; ?></span>
